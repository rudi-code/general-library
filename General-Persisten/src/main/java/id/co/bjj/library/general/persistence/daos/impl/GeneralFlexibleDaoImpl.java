...
public class GeneralFlexibleDaoImpl<M, ID extends Serializable> implements GeneralFlexibleDao<M, ID> {
	protected static Logger log = LogManager.getLogger(GeneralFlexibleDaoImpl.class);
	...
	protected GeneralFlexibleDaoImpl(@Qualifier("conditionEquals") WherePredicateBuilder<M> conditionEquals,
	...
	protected List<jakarta.persistence.criteria.Order> criteriaOrderBuilder(CriteriaBuilder criteriaBuilder,
			Root<M> root, List<OrderDto> orders) {
