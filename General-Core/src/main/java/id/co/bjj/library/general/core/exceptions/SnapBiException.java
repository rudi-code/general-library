...
@Slf4j
public class SnapBiException extends RuntimeException {
	private static final long serialVersionUID = -325835457292194541L;
	private List<Error> errors = new ArrayList<>();
	private Error error;
	protected int httpStatus;

	public SnapBiException() {
		super();
	}

	public SnapBiException(List<Error> errors, int httpStatus) {
		super();
		this.errors = errors == null ? new ArrayList<>() : errors;
		this.httpStatus = httpStatus;
	}

	public SnapBiException(Error exceptionKey) {
	...
	public SnapBiException(String message, Throwable t) {
